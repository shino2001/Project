    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-4">
        ...
        <select name="grade" class="form-control">
          ...
          <option value="1st">IELTS</option>
          <option value="2nd">OET</option>
          <option value="3rd">PSC</option>
          <option value="4th">UPSC</option>
          <option value="5th">NEET</option>
          <option value="6th">KEAM</option>
          <option value="7th">NDA</option>
        </select>
      </div>
