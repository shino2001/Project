      ...
      <div class="masthead">
        <h3>
          <b><a href="../index.php">Back</a></b>
            <a data-toggle="modal" href="#colins" class="pull-right"><b></b></a>
        </h3>
        <nav>
            ...
            <div class="modal-body" style="padding:40px 50px;">
              ...
              <form class="form-horizontal" action="#" name="form" method="post">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="lname" class="form-control" placeholder="Firstname" required="required">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-4 control-label">Emp Id</label>
                  <div class="col-sm-8">
                    <input type="text" name="fname" class="form-control" placeholder="Emp Id" required="required">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select name="emp_type" class="form-control" placeholder="Employee Type" required>
                      ...
                      <option value="Job Order">Full time</option>
                      <option value="Regular">Part Time</option>
                      <option value="Casual">Others</option>
                    </select>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select name="division" class="form-control" placeholder="Division" required>
                      ...
                      <option value="Human Resource">Teachers</option>
