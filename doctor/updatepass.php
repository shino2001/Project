...
if ($sessObj->isLogged() == true) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = "UPDATE tbl_login SET `password`='$password' where `l_id`='" . $user_data['log_id'] . "'";
            ...
            <div class="col-md-12">
                <form method="POST" action="" enctype="multipart/form-data" onsubmit="return validate();">
                    ...
                    <div class="form-group col-12 mt-2">
                        <label class="mt-2 text-dark">Password:</label><br>
                        <input type="password" class="form-control mt-2" minlength="6" id="password" name="password" placeholder="Password" onblur="validate_password()">
                        <label class="mt-2 text-dark">Confirm Password:</label><br>
                        <input type="password" minlength="6" class="form-control mt-2" id="cpassword" name="cpassword" placeholder="Confirm Password" onblur="validate_confirm()">
