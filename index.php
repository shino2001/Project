...
<head>
  ...
  <!-- Site Metas -->
  <link rel="icon" href="images/fbb.png" type="image/gif" />
  ...
  <!-- bootstrap core css -->
  <link rel="stylesheet" type="text/css" href="css/bootstra.css" />
  <!-- font awesome style -->
        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#cate">Courses</a>
              </li>
              <li class="nav-item">
...
<script src="http://translate.google.com/translate_a/element.js?cb=loadGoogleTranslate"></script>
  ...
  <section id= "cate" class="catagory_section layout_padding">
    <div class="catagory_container">
      <div class="container ">
        <div class="heading_container heading_center">
          <h2>
            Top Online Coachings
          </h2>
          <p>
          simply is the Best Online Coaching  for NEET, JEE Main and Advanced, IIT, AIIMS, JIPMER, Medical & Engineering academy
          </p>
        </div>
        <div class="row">
  ...
  <section id="abt" class="about_section layout_padding">
    <div class="container ">
      <div class="row">
        <div class="col-md-6">
          <div class="img-box">
  ...
  <section id="Emp"class="client_section layout_padding">
    <div class="container ">
      <div class="heading_container heading_center">
        <h2>
          Our Top Employees
