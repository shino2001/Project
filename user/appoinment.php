        ...
        <div class="row m-2">
            <div class="col-lg-12">
                ...
                <div class="row form-group">
                    <div class="form-group col-md-3 space-between">
                        <label for="exampleInputEmail1" class="form-label text-dark">Enter Comment</label>
                        <input type="text" class="form-control" placeholder="Please enter Comment" id="symptomInp">
                    </div>
                </div>
